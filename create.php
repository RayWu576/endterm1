...
<body>
    ...
    <div class="container">
        ...
        <div class="create-activity" style="margin-top: 20%; visibility: visible;">
            <form action="create.php" method="post">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="start-date" placeholder="2023/12/25" name="start-date">
                    </div>
                </div>
                <div class="form-group">
                    <label for="end-date">活動結束日期</label>
                    <input type="text" class="form-control" id="end-date" placeholder="2023/1/5" name="end-date">
                </div>
                <div class="form-group">
                    <label for="location">Address 2</label>
                    <input type="text" class="form-control" id="location" placeholder="Apartment, studio, or floor" name="location">
                </div>
                ...
                <div class="form-group">
                    <label for="capacity">舉辦人數上限</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cost" placeholder="30元新台幣" name="cost">
                </div>

                <div class="form-group">
                    <label for="register-deadline">報名期限</label>
                    <input type="text" class="form-control" id="register-deadline" placeholder="2023/12/20" name="register-deadline">
                </div>
        ...
        <div class="create-course" style="margin-top: 20%; visibility: hidden;">
            <form action="create.php" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="input-activity-name">課程名稱</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="year" placeholder="100" name="year">
                </div>

                <div class="form-group">
                    <label for="semester">學期</label>
                    <input type="text" class="form-control" id="semester" placeholder="100" name="semester">
                </div>

                <div class="form-group">
                    <label for="additional-info">額外資訊</label>
                    <input type="text" class="form-control" id="additional-info" placeholder="100" name="additional-info">
                </div>

                <div class="form-group">
                    <label for="hours">時數</label>
                    <input type="text" class="form-control" id="hours" placeholder="100" name="hours">
                </div>
    ...
    <script src="index_copy.js"></script>
</body>
